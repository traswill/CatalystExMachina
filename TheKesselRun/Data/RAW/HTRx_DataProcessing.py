...
def read_spreadsheet_3():
    referencedata_df = load_info_sheet(r'.//NH3rxn3_TW.xlsx', thresh=10,  sheetname='Redo')
    activitydata_df = load_activity_sheet(pth=r'./NH3rxn3_TW.xlsx', sheet='Data 25 Jan 2018', cols='A,E')
